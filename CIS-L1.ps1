...
# 2.3.1.5 Rename Guest account
try {
    $gst = Get-LocalUser -Name "Guest" -EA SilentlyContinue
    if ($gst -and $gst.Name -eq "Guest") {
        Rename-LocalUser -Name "Guest" -NewName "LocalGuest_CIS"
